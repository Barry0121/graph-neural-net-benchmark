#####################################################################################
# Model Component Module (PyTorch Geometric)                                        #
#                                                                                   #
# Description:                                                                      #
# This module contains components for GCN, GCN-AE, GCN-VAE, GraphSage and            #
# more models implemented using pytorch-geometric 2.1.0                             #
#                                                                                   #
# Code References:                                                                  #
